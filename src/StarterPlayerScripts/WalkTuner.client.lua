...
local GROUPS = {
	{ "Step", { "StepLength", "StepHeight", "DutyFactor", "StanceWidth", "FootAhead", "AnkleHeight", "MaxStride", "MaxReach", "PhaseRecover" } },
	{ "Direction", { "FootTurnToMove", "MaxFootYaw", "MaxFootLag", "PivotRate", "SideStepRatio", "FootTurnTime", "TurnRate", "FootSpeedRatio", "MinFootSpeed" } },
